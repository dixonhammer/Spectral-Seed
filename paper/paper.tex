...
The exact repository snapshot corresponding to this manuscript is archived at Zenodo under DOI: \texttt{TBD} (release tag \texttt{v1.0.0}), ensuring commit-level reproducibility.
